...
export default function AffiliatesPage() {
  ...
  useEffect(() => {
    async function fetchAffiliates() {
      ...
      try {
        ...
        const response = await api.affiliates.get(params.toString() as never)
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Affiliates"
        description="Manage your affiliates and partnerships"
      >
            ...
            {loading ? (
              ...
              affiliates.map((affiliate) => (
                <TableRow key={affiliate.id}>
                  ...
                  <TableCell>{affiliate.companyName || "-"}</TableCell>
                  <TableCell className="text-muted-foreground">
                    {affiliate.email}
                  </TableCell>
                  <TableCell>{affiliate.accountManager?.name || "-"}</TableCell>
                  <TableCell>
