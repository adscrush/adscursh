              ...
              <div className="flex">
                  ...
                  <div className="flex flex-col gap-1 border-r border-foreground/10 pr-4 text-left">
                    {dateRanges.map(({ label, start, end }) => (
                      <Button
                        ...
                        size="sm"
                        className={cn(
                          "justify-start text-xs hover:bg-primary/90",
                          selectedRange === label &&
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-4">
                    <div className="ml-3 flex w-full gap-2">
                      <Select
                        onValueChange={(value) => {
                      ...
                      >
                        <SelectTrigger className="w-full min-w-[120px] text-xs font-medium hover:bg-accent hover:text-accent-foreground focus:ring-0 focus:ring-offset-0">
                      ...
                      >
                        <SelectTrigger className="w-1/2 min-w-[90px] text-xs font-medium hover:bg-accent hover:text-accent-foreground focus:ring-0 focus:ring-offset-0">
